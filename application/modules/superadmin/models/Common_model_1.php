...
class Common_model extends CI_Model
{
    ...
    public function get_transaction_list($where = array())
    {
        ...
        $result = $this->db->order_by("transaction_id", "desc")
            ->get();
    ...
    {
        $this->email->from('info@fennelinfotech.com', 'Global markets centre');
