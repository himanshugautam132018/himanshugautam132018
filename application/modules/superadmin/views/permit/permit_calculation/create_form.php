    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="wrapper">
                ...
                <form method="POST" id="create_permit_calculation" action="<?php echo base_url("superadmin/permit/create_update_permi_calculation"); ?>" enctype="multipart/form-data">
                    <div class="form-group row">
                    <div class="col-md-3">
                            <label for="name">Overall Operator</label>
                            <select name="overall_operator" id="overall_operator" class="form-control" required>
                            <option value="">Please seclect operator</option>
                                <option value=">">  <?php echo !empty($permit_calculation->xcmg_overall_operator) && $permit_calculation->xcmg_overall_operator==">"?"selected":""?>> </option>
                                <option value="<" <?php echo !empty($permit_calculation->xcmg_overall_operator) && $permit_calculation->xcmg_overall_operator=="<"?"selected":""?>>
                                    < </option>
                                <option value=">=" <?php echo !empty($permit_calculation->xcmg_overall_operator) && $permit_calculation->xcmg_overall_operator==">="?"selected":""?>> >= </option>
                                <option value="<=" <?php echo  !empty($permit_calculation->xcmg_overall_operator) && $permit_calculation->xcmg_overall_operator=="<="?"selected":""?>>
                                    <= </option>
                    ...
                    <div class="col-md-3">
                           ...
                           <label for="name">Select Truck type <sup>*</sup></label>
                            <select name="truck_type_id" id="truck_type_id" class="form-control">
                                <?php
                                if (!empty($truck_type)) {
                                  
                                    foreach ($truck_type as $t_list) {
                                        $selected = !empty($permit_calculation->xcp_truck_type_id) && $permit_calculation->xcp_state_id == $t_list['tab_id'] ? "selected" : "";
                                ?>

                                        <option <?php echo $selected; ?> value="<?php echo $t_list['tab_id']; ?>"><?php echo $t_list['xcmg_truck_type_name']; ?></option>
                                    <?php }
                                } else { ?>
                        ...
                        <div class="col-md-3">
                            <?php
                            if (!empty($permit_calculation->xcp_id)) {
                            ?>
                                <input type="hidden" name="calculation_id" value="<?php echo $permit_calculation->xcp_id; ?>">
                            <?php }
                            ?>
                            ...
                            <select name="state_id" id="state_id" class="form-control">
                                ...
                                if (!empty($state_list)) {
                                    foreach ($state_list as $s_list) {
                                        $selected = !empty($permit_calculation->xcp_state_id) && $permit_calculation->xcp_state_id == $s_list['state_id'] ? "selected" : "";
                                ?>

                                        <option <?php echo $selected; ?> value="<?php echo $s_list['state_id']; ?>"><?php echo $s_list['state_name'] . " (" . $s_list['state_code'] . ")"; ?></option>
                                    <?php }
                                } else { ?>
                            ...
                            <select name="permit_type_id" id="permit_type_id" class="form-control">
                                ...
                                if (!empty($permit_type)) {
                                    foreach ($permit_type as $p_type) {
                                        $selected_option = !empty($permit_calculation->xcp_permit_type_id) && $permit_calculation->xcp_permit_type_id == $p_type['permit_id'] ? "selected" : "";

                                ?>

                                        <option <?php echo $selected_option; ?> value="<?php echo $p_type['permit_id']; ?>"><?php echo $p_type['permit_type']; ?></option>
                                    <?php }
                                } else { ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                           ...
                           <option value="">Please seclect operator</option>
                                <option value=">">  <?php echo !empty($permit_calculation->xcp_width_rule_operator) && $permit_calculation->xcp_width_rule_operator==">"?"selected":""?>> </option>
                                <option value="<" <?php echo !empty($permit_calculation->xcp_width_rule_operator) && $permit_calculation->xcp_width_rule_operator=="<"?"selected":""?>>
                                    < </option>
                                <option value=">=" <?php echo !empty($permit_calculation->xcp_width_rule_operator) && $permit_calculation->xcp_width_rule_operator==">="?"selected":""?>> >= </option>
                                <option value="<=" <?php echo  !empty($permit_calculation->xcp_width_rule_operator) && $permit_calculation->xcp_width_rule_operator=="<="?"selected":""?>>
                                    <= </option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            <option value="no">Please seclect operator</option>
                            <option value="">Please seclect operator</option>
                                <option value=">">  <?php echo !empty($permit_calculation->xcp_height_rule_operator) && $permit_calculation->xcp_height_rule_operator==">"?"selected":""?>> </option>
                                <option value="<" <?php echo !empty($permit_calculation->xcp_height_rule_operator) && $permit_calculation->xcp_height_rule_operator=="<"?"selected":""?>>
                                    < </option>
                                <option value=">=" <?php echo !empty($permit_calculation->xcp_height_rule_operator) && $permit_calculation->xcp_height_rule_operator==">="?"selected":""?>> >= </option>
                                <option value="<=" <?php echo  !empty($permit_calculation->xcp_height_rule_operator) && $permit_calculation->xcp_height_rule_operator=="<="?"selected":""?>>
                                    <= </option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <label for="name">Length limit (ft) CL</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <option value="no">Please seclect operator</option>
                            <option value="">Please seclect operator</option>
                                <option value=">">  <?php echo !empty($permit_calculation->xcp_length_limit_operator) && $permit_calculation->xcp_length_limit_operator==">"?"selected":""?>> </option>
                                <option value="<" <?php echo !empty($permit_calculation->xcp_length_limit_operator) && $permit_calculation->xcp_length_limit_operator=="<"?"selected":""?>>
                                    < </option>
                                <option value=">=" <?php echo !empty($permit_calculation->xcp_length_limit_operator) && $permit_calculation->xcp_length_limit_operator==">="?"selected":""?>> >= </option>
                                <option value="<=" <?php echo  !empty($permit_calculation->xcp_length_limit_operator) && $permit_calculation->xcp_length_limit_operator=="<="?"selected":""?>>
                                    <= </option>
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            <label for="name">Front Overhang (ft) FO</label>
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            <label for="name">Rear Overhang (ft) RO</label>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            <option value=">">  <?php echo !empty($permit_calculation->xcp_axle_width_operator) && $permit_calculation->xcp_axle_width_operator==">"?"selected":""?>> </option>
                                <option value="<" <?php echo !empty($permit_calculation->xcp_axle_width_operator) && $permit_calculation->xcp_axle_width_operator=="<"?"selected":""?>>
                                    < </option>
                                <option value=">=" <?php echo !empty($permit_calculation->xcp_axle_width_operator) && $permit_calculation->xcp_axle_width_operator==">="?"selected":""?>> >= </option>
                                <option value="<=" <?php echo  !empty($permit_calculation->xcp_axle_width_operator) && $permit_calculation->xcp_axle_width_operator=="<="?"selected":""?>>
                                    <= </option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <label for="name">Tridem (lb/in)</label>
                            <input type="text" class="form-control" id="tridem_lb_in" name="tridem_lb_in" value="<?php echo !empty($permit_calculation->xcp_tridem_lb_in) ? $permit_calculation->xcp_tridem_lb_in : '' ?>" placeholder="Tridem (lb/in)">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            <option value=">">  <?php echo !empty($permit_calculation->xcp_gvw_operator) && $permit_calculation->xcp_gvw_operator==">"?"selected":""?>> </option>
                                <option value="<" <?php echo !empty($permit_calculation->xcp_gvw_operator) && $permit_calculation->xcp_gvw_operator=="<"?"selected":""?>>
                                    < </option>
                                <option value=">=" <?php echo !empty($permit_calculation->xcp_gvw_operator) && $permit_calculation->xcp_gvw_operator==">="?"selected":""?>> >= </option>
                                <option value="<=" <?php echo  !empty($permit_calculation->xcp_gvw_operator) && $permit_calculation->xcp_gvw_operator=="<="?"selected":""?>>
                                    <= </option>
                    ...
                    success: function(data) {
                        if (data.status === true) {
                            ...
                            Swal.fire(
                                ...
                                window.location.href = base_url + "superadmin/permit/permit_calculation";
                            });
